...
using RxPlatform.Hosting.Threading;
using System.Runtime.InteropServices;

namespace ENSACO.RxPlatform.Hosting.CallbackInterface
{
...
#pragma warning disable CS0649
    internal unsafe struct dotnet_loading_api_t
    {
        ...
        internal IntPtr mapper_write_done;    // dotnetMapperWriteDone_t
...
#pragma warning restore CS0649
    ...
    internal unsafe delegate void dotnetMapperWriteDoneDelegate(
        UInt64 transId
        , nint instance
        , rx_result_struct result);
    ...
    internal class InitDataAPI
    {
        internal unsafe void Init(ref dotnet_loading_api_t api)
        {
            ...
            MapperWriteDone = (dotnetMapperWriteDoneDelegate)Marshal.GetDelegateForFunctionPointer(api.mapper_write_done, typeof(dotnetMapperWriteDoneDelegate));
            ...
            , string def)
        {
            ...
            var task = HostThreadingSinyhronizator.AppendExceptioned();
        ...
        internal dotnetMapperWriteDoneDelegate? MapperWriteDone { get; set; } = null;
