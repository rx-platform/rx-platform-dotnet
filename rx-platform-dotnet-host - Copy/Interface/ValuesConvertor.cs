...
namespace RxPlatform.Hosting.Interface
{
    internal static class ValuesConvertor
    {
        ...
        unsafe internal static bool ConvertValueFromRx(typed_value_type* val, ref object? value)
        {
            int temp = 0;
                ...
                case rx_value_t.String:
                    {
                        ...
                        if (ConvertValueFromRxString(val, ref str))
                        {
                            value = str;
                            return true;
                        }
                    ...
                    {
                        double d = 0;
                        if (ConvertValueFromRxFloat(val, ref d))
                        {
                            value = d;
                            return true;
                        }
                    ...
                    {
                        double f = 0;
                        if (ConvertValueFromRxFloat(val, ref f))
                        {
                            value = (float)f;
                            return true;
                        }
                    ...
                    {
                        ulong ul = 0;
                        if (ConvertValueFromRxUint(val, ref ul))
                        {
                            value = ul;
                            return true;
                        }
                    ...
                    {
                        ulong ui = 0;
                        if (ConvertValueFromRxUint(val, ref ui))
                        {
                            value = (uint)ui;
                            return true;
                        }
                    ...
                    {
                        ulong us = 0;
                        if (ConvertValueFromRxUint(val, ref us))
                        {
                            value = (ushort)us;
                            return true;
                        }
                    ...
                    {
                        ulong b = 0;
                        if (ConvertValueFromRxUint(val, ref b))
                        {
                            value = (byte)b;
                            return true;
                        }
                    ...
                    {
                        long l = 0;
                        if (ConvertValueFromRxInt(val, ref l))
                        {
                            value = l;
                            return true;
                        }
                    ...
                    {
                        long i = 0;
                        if (ConvertValueFromRxInt(val, ref i))
                        {
                            value = (int)i;
                            return true;
                        }
                    ...
                    {
                        long s = 0;
                        if (ConvertValueFromRxInt(val, ref s))
                        {
                            value = (short)s;
                            return true;
                        }
                    ...
                    {
                        long sb = 0;
                        if (ConvertValueFromRxInt(val, ref sb))
                        {
                            value = (sbyte)sb;
                            return true;
                        }
