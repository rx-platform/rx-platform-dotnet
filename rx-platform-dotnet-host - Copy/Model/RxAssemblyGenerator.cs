...
namespace ENSACO.RxPlatform.Hosting.Model
{
    ...
    {
        private static void ConnectMapperType(string typeName, ref PlatformTypeBuildMeta<RxPlatformMapper> type, Assembly assembly)
        {
        ...
        private static void ConnectEventType(string typeName, ref PlatformTypeBuildMeta<RxPlatformEvent> type, Assembly assembly)
        {
            Type? dynamicType = assembly.GetType(typeName, false);
            if (dynamicType != null)
            {
        ...
        private static void ConnectSourceType(string typeName, ref PlatformTypeBuildMeta<RxPlatformSource> type, Assembly assembly)
        {
            Type? dynamicType = assembly.GetType(typeName, false);
            if (dynamicType != null)
            {
        ...
        internal static void GenerateAssembly(PlatformTypeBuildData tempData, HostedPlatformLibrary hostLib)
        {
            ...
            var sourceCode = GetTypeSourceCode(tempData, hostLib);
        ...
        private static string GetTypeSourceCode(PlatformTypeBuildData tempData, HostedPlatformLibrary hostLib)
        {
