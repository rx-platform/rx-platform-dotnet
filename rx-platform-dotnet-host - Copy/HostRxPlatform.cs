...
namespace ENSACO.RxPlatform.Hosting.Internal
{
    ...
    internal class RxPlatformObject
    {
        ...
        {
            if (PlatformABI.platformABI.pWriteLog != null)
            {
                PlatformABI.platformABI.pWriteLog(pluginId, (int)log_event_type.info, GetPluginName(), source, severity, "", message);
            }
        }
        public void WriteLogError(string source, ushort severity, string message)
        {
            if (PlatformABI.platformABI.pWriteLog != null)
            {
                PlatformABI.platformABI.pWriteLog(pluginId, (int)log_event_type.error, GetPluginName(), source, severity, "", message);
            }
        }
        public void WriteLogWarning(string source, ushort severity, string message)
        {
            if (PlatformABI.platformABI.pWriteLog != null)
            {
                PlatformABI.platformABI.pWriteLog(pluginId, (int)log_event_type.warning, GetPluginName(), source, severity, "", message);
            }
        }
        public void WriteLogDebug(string source, ushort severity, string message)
        {
            if (PlatformABI.platformABI.pWriteLog != null)
            {
                PlatformABI.platformABI.pWriteLog(pluginId, (int)log_event_type.debug, GetPluginName(), source, severity, "", message);
            }
        }
        public void WriteLogTrace(string source, ushort severity, string message)
        {
            if (PlatformABI.platformABI.pWriteLog != null)
            {
                PlatformABI.platformABI.pWriteLog(pluginId, (int)log_event_type.trace, GetPluginName(), source, severity, "", message);
            }
        }
        public void WriteLogCritical(string source, ushort severity, string message)
        {
            if (PlatformABI.platformABI.pWriteLog != null)
            {
                PlatformABI.platformABI.pWriteLog(pluginId, (int)log_event_type.critical, GetPluginName(), source, severity, "", message);
            }
        }
    }
}
